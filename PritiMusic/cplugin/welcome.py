...
async def set_custom_welcome(client, message):
    ...
    if not message.reply_to_message and not cmd_text:
        example_text = (
            ...
            "[❤ Dᴇᴠᴇʟᴏᴘᴇʀ](buttonurl:https://t.me/MrPerfectXd color:red) | [✅ Uᴘᴅᴀᴛᴇs](buttonurl:https://t.me/TitanNetwrk color:green)\n"
            "[🛠 Sᴜᴘᴘᴏʀᴛ](buttonurl:https://t.me/Musical_Beatsz color:blue)`\n\n"
